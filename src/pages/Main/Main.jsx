        ...
        <>
            <Card>
                ...
                <p>
                    ...
                    on-chain! right! When each little punk is minted, a generative algorithm is run
                    to produce a random punk, which you can see an example of here. Each punk is
                    self-contained on the ethereum blockchain. In other words, the NFT itself is the
                    art.
                </p>
            </Card>
            <MintButton />
            ...
            <Card>
                ...
                <p>
                    ...
                    centralized server containing metadata. With many NFT on the market, you have to
                    trust that whoever is hosting the actual image keeps their promise to host the
                    artwork for the entire life of the ethereum blockchain.
                    <br />
                    <br />
