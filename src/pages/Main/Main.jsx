    ...
    <>
      <Card>
        ...
        <p>
          ...
          you can see an example of here. Each punk is self-contained on the
          ethereum blockchain. In other words, the NFT itself is the art.
        </p>
      </Card>
      <Card>
        <CardHeader text="~ Pricing ◕ᴥ◕" />
        <p>
